...
import 'package:example/MainScreen//HomePage.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          '프로필 설정',
          style: TextStyle(color: const Color(0xFFFFF8DE)), // 제목 색상 변경
        ),
        centerTitle: true,
                        ...
                        children: [
                          ...
                          TextField(
                            ...
                            decoration: InputDecoration(
                              ...
                              labelStyle: TextStyle(color: const Color(0xFFFFF8DE)), // '닉네임' 텍스트 색상 설정
                              filled: true,
                            ...
                            child: SizedBox(
                              ...
                              child: ElevatedButton(
                                ...
                                child: Text(
                                  '시작하기',
                                  style: TextStyle(
                                    color: const Color(0xFFFFF8DE), // '시작하기' 글자 색상
                                  ),
                                ),
