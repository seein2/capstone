...
import 'package:example/main.dart';  // main.dart 파일 경로 수정
import 'package:example/MainScreen/ProfileSettingPage.dart';  // ProfileSettingPage.dart 파일 경로 수정
import 'package:example/MainScreen/CommunityPage.dart';  // CommunityPage.dart 파일 경로 수정
import 'package:example/MainScreen/PostPage.dart';  // PostPage.dart 경로 추가
import 'package:example/models/post.dart';  // post.dart 경로 수정
import 'package:example/models/user.dart';  // user.dart 경로 수정
